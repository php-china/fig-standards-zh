...
本文档描述了在[RFC 7230](http://tools.ietf.org/html/rfc7230) 和
[RFC 7231](http://tools.ietf.org/html/rfc7231) 中规定的关于HTTP消息的通用接口，以及在 [RFC 3986](http://tools.ietf.org/html/rfc3986) 中规定的HTTP消息中URI的使用。
